...
public class Error {
    ...
    public static synchronized void errorNoSource(String msg) {
        ...
        if (instance.bus != null) instance.bus.publishEvent(EventFactory.makeErrorEvent(msg));
    ...
    public static synchronized void initialise(EventBus bus) {
        ...
        else hardErrorExplicitSource("Error::initialise", "Attempt to reinitialise Error singleton");
    }
