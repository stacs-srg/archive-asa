...
public class Output {
	...
	public void outputExperimentalSetup(int numNodes, SimulationFactory sf){
		printStream.println("Experimental setup:");
		printlnSeparated("Number of nodes",numNodes);
		printlnSeparated("SimulationFactory implmentation",sf.getClass().getName());
	}
