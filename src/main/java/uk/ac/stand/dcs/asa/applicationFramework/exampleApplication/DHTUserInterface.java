...
public class DHTUserInterface extends JPanel{
    ...
    private JButton storeDataSpecKey = new JButton("Store Data with Specified Key");
    ...
    private JLabel keyConstructionLabel = new JLabel("Text for key construction:");
    ...
    private DHTComponent dhtComponent;
    
    public DHTUserInterface(DHTComponent dhtComponent){
        this.dhtComponent=dhtComponent;
    ...
    public void enableControls(){
        activated=true; 
        if(currentKey!=null)lookup.setEnabled(true);
    ...
    private void initialise() {
        ...
        makeKey.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(s.compareTo("")!=0){
                    DefaultListModel dlm = (DefaultListModel) keyList.getModel();
                    ...
                    if(kss==null){
                        try{
                            ...
                            consoleTxt.setText("\""+s+"\" is not valid. Use of the \"Make Key\" button requires that you enter a hexidecimal integer representation in the text box.");
                            return;
                        }
                    }
...
//      RECEIVED MESSAGE TEXT AREA PROPERTIES
        ...
        lookup.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if(currentKey!=null)getString(currentKey);
            }
        });
        ...
        keyList.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent arg0) {/* no action */}
            public void mouseExited(MouseEvent arg0) {/* no action */}
            public void mousePressed(MouseEvent arg0) {/* no action */}
            public void mouseReleased(MouseEvent arg0) {/* no action */}
        });     
        ...
        keyList.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent arg0) {/* no action */}
        });
            ...
            public void keyPressed(KeyEvent arg0) {
                if(!storedKeyList.isSelectionEmpty()){
                    ...
                    if(arg0.getKeyCode()==KeyEvent.VK_DELETE){
                        ...
                        DefaultListModel dlm = (DefaultListModel) storedKeyList.getModel();
                        if(index>=0&&index<dlm.getSize()){
                            dlm.remove(index);
        ...
        this.add(dataLabel, new GridBagConstraints(0, 0, 2, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        
        this.add(dataTextScroll, new GridBagConstraints(0, 1, 1, 4, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));       
        this.add(storeData, new GridBagConstraints(1, 1, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        this.add(storeDataSpecKey, new GridBagConstraints(1, 2, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        this.add(hashData, new GridBagConstraints(1, 3, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        ...
        this.add(retrievedLabel, new GridBagConstraints(0, 5, 2, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        
        this.add(retrievedScroll, new GridBagConstraints(0, 6, 1, 4, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        
        this.add(keyLabel, new GridBagConstraints(1, 6, 1, 1, 1.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        
        this.add(keyDisplay, new GridBagConstraints(1, 7, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        
        this.add(lookup, new GridBagConstraints(1, 8, 1, 1, 1.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0)); 
        
        this.add(keyListScroller, new GridBagConstraints(1, 9, 1, 1, 1.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        
        this.add(keyGenLabel, new GridBagConstraints(1, 10, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));

        this.add(keyGenDisplayScroller, new GridBagConstraints(1, 11, 1, 3, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        ...
        this.add(keyConstructionTxt, new GridBagConstraints(0, 11, 1, 1, 0.0,
                ...
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        this.add(makeKey, new GridBagConstraints(0, 12, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        this.add(hashTxt, new GridBagConstraints(0, 13, 1, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        this.add(consoleLabel, new GridBagConstraints(0, 14, 2, 1, 0.0,
                0.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 0,
                        0), 0, 0));
        this.add(consoleScroller, new GridBagConstraints(0, 15, 2, 1, 0.0,
                1.0, GridBagConstraints.NORTHWEST,
                GridBagConstraints.NONE, new java.awt.Insets(5, 5, 5,
                        5), 0, 0));
    ...
    protected void storeString(IKey k,String s) {
        ...
        try {
            if(k==null){
                IKey storedKey=dhtComponent.put(s);
                if(storedKey==null){
                    String output = "Failed to store string:\n"+s+"\nwith unspecified key.";
                    output2console(output);
                }else{
                    if(k==null)addKey(storedKey.toString(),storedKey,storedKeyList);
                }
            }else{
                if(!dhtComponent.put(k,s)){
                    String output = "Failed to store string:\n"+s+"\nwith key "+k;
                    output2console(output);
                }
            }
    ...
    protected void getString(IKey k) {
        ...
        try {
            String s=dhtComponent.getString(k);
            output2recieved(s);
        } catch (P2PApplicationException e) {
    ...
    public static void main(String[] args) {
        JFrame f = new JFrame();
        f.setSize(900,700);
        f.getContentPane().add(new DHTUserInterface(null));
        f.show();
    }
