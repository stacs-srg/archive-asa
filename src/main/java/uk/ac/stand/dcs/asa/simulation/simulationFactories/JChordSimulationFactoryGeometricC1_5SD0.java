 ...
 */
public class JChordSimulationFactoryGeometricC1_5SD0 extends AbstractSimulationFactory  {

    public P2PSim makeSimulation(int num_nodes) {
    	IDistanceCalculator dc=new SimulatedPhysicalDistanceModel(num_nodes);
		IFingerTableFactory ftf=new GeometricFingerTableFactory(1.5,0,dc,false);
