...
public class StoreInfoServiceComponent extends AbstractStorageComponent implements IStore_Net{

    public static final AID StoreInfoServiceComponent_AID = new AIDImpl(
            "7701B9D2-8F15-25E8-1AC1-08ACCD081BE3");

    public StoreInfoServiceComponent(P2PApplicationFramework framework, IReplicatingDataStoreFactory rdsFac) {
        super(framework,rdsFac,StoreInfoServiceComponent_AID);
    }
