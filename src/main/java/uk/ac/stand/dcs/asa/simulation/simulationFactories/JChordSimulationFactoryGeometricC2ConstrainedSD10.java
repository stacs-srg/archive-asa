 ...
 */
public class JChordSimulationFactoryGeometricC2ConstrainedSD10 extends AbstractSimulationFactory   {

    public P2PSim makeSimulation(int num_nodes) {
    	IDistanceCalculator dc=new SimulatedPhysicalDistanceModel(num_nodes);
		IFingerTableFactory ftf=new GeometricFingerTableFactory(2.0,10,dc,true);
