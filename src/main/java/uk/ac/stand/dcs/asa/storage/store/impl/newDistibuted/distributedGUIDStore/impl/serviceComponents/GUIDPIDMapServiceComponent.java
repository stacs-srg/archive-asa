...
public class GUIDPIDMapServiceComponent extends AbstractStorageComponent implements IStore_Net{
  
    public static final AID GUIDPIDMapServiceComponent_AID = new AIDImpl(
            "8FE8C0F8-59A5-80AD-EE8F-D6C13E2D3F56");

    /**
     * @param framework
     */
    public GUIDPIDMapServiceComponent(P2PApplicationFramework framework, IReplicatingDataStoreFactory rdsFac) {
        super(framework,rdsFac,GUIDPIDMapServiceComponent_AID);
    }
