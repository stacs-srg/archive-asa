 ...
 */
public class JChordSimulationFactoryGeometricC2SD20 extends AbstractSimulationFactory {

    public P2PSim makeSimulation(int num_nodes) {
    	IDistanceCalculator dc=new SimulatedPhysicalDistanceModel(num_nodes);
		IFingerTableFactory ftf=new GeometricFingerTableFactory(2.0,20,dc,false);
